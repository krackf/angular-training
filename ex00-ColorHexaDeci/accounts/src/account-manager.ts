...
interface IActivatedUser extends IUser{
  isActive:Boolean;
}

interface IAdmin extends IActivatedUser{
  adminSince:Date;
}
...
export class AccountManager {
   ...
   */
  activateNewUser(approver:IAdmin, userToApprove:IActivatedUser) {
   ...
   */
  promoteToAdmin(existingAdmin:IAdmin, user:IActivatedUser) {
